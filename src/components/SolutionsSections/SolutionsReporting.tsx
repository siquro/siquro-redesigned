...
const SolutionsReporting = () => {
    return (<section className="services__reporting--section container  mt-16">
        <div className="reporting--container flex flex-col md:flex-row px-11 dark:border-primaryLight border-2 pt-1 pb-5 border-primaryDark">
            ...
            <div className="pt-[50px] pb-[62px] w-3/5 px-10 ">
                ...
                <h2 className="title-h2 mb-8">Fraud & Risk Management</h2>
                ...
                <p className="title-h4 uppercase mb-8"> Geographic coverage around the world</p>
                <p className="title-h4 uppercase mb-11">Cascading payments</p>
