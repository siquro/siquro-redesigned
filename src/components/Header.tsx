...
const Header = () => {
    ...
    return (
        <header className="container relative z-50">
            <div className="flex flex-row  md:flex-wrap lg:flex-nowrap items-center justify-between px-1  py-5 md:py-8 bg-primaryDark dark:bg-transparent  rounded-b-[15px]">
