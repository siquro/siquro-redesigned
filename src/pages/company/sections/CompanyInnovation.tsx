...
export const CompanyInnovation = () => {
    return (<section className="services__reporting--section auto-padding">
        <div className="reporting--container flex flex-col sm:flex-row border-0 sm:border-[3px] sm:border-white">
            ...
            <div className="pt-[65px] pb-[55px] bg-companyInovationBg bg-no-repeat bg-center sm:bg-none w-full sm:w-1/2 ps-5 lg:ps-5 pe-5 lg:pe-10">
                ...
                <p className="text-[20px] lg:text-[24px] font-bold font-montserrat mb-16 uppercase">Geographic coverage around the world</p>
                ...
                <p className="text-[20px] lg:text-[24px] font-bold font-montserrat mb-16 uppercase">Monitoring transactions and preventing fraudulent payments</p>
